...
requireText(bell, 'notificationT("bell.viewAll")', "quick panel full-center entry");
requireText(bell, 'navigate("/notifications")', "quick panel full-center navigation");
requireText(center, 'scope === "unread"', "unread filter");
requireText(center, "getNotificationTypeOptions()", "type filter");
